...
#text=["하이 하이 만나서 만나서 반가워 정말 정말 반가워 중국어로 너무 귀찮은 거에요 이렇게 사귀고 있는 건지도 몰랐어요","안녕하세요 하이", "안녕하세요 하이 만나서 반가워","안녕 하이 하이","안녕 반가워","하이요"]
text=["코레 일 합격한 자기소개 안녕하십니까 지원번호 357번입니다 저는 2년 6개월 동안 약 50군데의 현장에서 철도 시설물 유지보수 업무와 약 150대의 배차 재생 업무를 수행한 경험이 있습니다 항상 업무를 하면서 안전 마인드를 되새겼고 사명감을 가지고 일하려고 노력을 했습니다 그 결과 저와 제 동료들은 단 한 번에 안전사고 없이 무사히 현장을 마무리 지을 수 있었습니다 한국철도공사에 입사한 후에도 저의 안전 마인드와 사명감을 바탕으로 안전한 현장을 만드는 데에 기여하겠습니다 감사합니다"]
